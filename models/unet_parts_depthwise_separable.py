...
from models.layers import DepthwiseSeparableConv, DepthwiseSeparableConv3D, CBAM, CBAM3D
...
class NodeInput3d(nn.Module):
    def __init__(self):
        super().__init__()
        self.ds3d1 = DepthwiseSeparableConv3D(in_channels = 1, out_channels = 256, kernel_size = 3, padding=1, stride=(2, 1, 1))
        ...
        self.pool = nn.AdaptiveMaxPool3d((4,4,1))
